...
function AuthProvider({ children }) {
        ...
        "AuthProvider.useEffect": ()=>{
            const checkSession = {
                "AuthProvider.useEffect.checkSession": async ()=>{
                    ...
                    try {
                        const data = await __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$api$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["authAPI"].me();
                        setUser(data.user);
                    } catch  {
                        setUser(null);
                    } finally{
    ...
    const login = async (username, password)=>{
        try {
            const data = await __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$api$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["authAPI"].login(username, password);
            setUser(data.user);
            return true;
        } catch  {
            return false;
    ...
    const logout = async ()=>{
        ...
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$api$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["authAPI"].logout();
        } catch  {
...
//# sourceMappingURL=frontend_lib_8882ed6e._.js.map